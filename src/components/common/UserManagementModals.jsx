...
export const PasswordChangeModal = ({ isOpen, onClose, user, onSubmit, passwordVisibility, togglePasswordVisibility }) => (
...
export const DeleteConfirmationModal = ({ isOpen, onClose, onConfirm }) => (
  <Modal isOpen={isOpen} onClose={onClose}>
    ...
    <div className="flex justify-end space-x-3">
      <SecondaryButton onClick={onClose}>Cancel</SecondaryButton>
      <GradientButton onClick={onConfirm}>Yes</GradientButton>
    </div>
  </Modal>
);

export const BlockUserModal = ({ isOpen, onClose, onConfirm, user }) => (
  <Modal isOpen={isOpen} onClose={onClose}>
    ...
    <div className="flex justify-end space-x-3">
      <SecondaryButton onClick={onClose}>Cancel</SecondaryButton>
      <GradientButton onClick={onConfirm}>Block User</GradientButton>
    </div>
  </Modal>
);

export const ResetPasswordModal = ({ isOpen, onClose, onConfirm, user }) => (
  <Modal isOpen={isOpen} onClose={onClose}>
