...
const ReportingPage = () => {
  ...
  return (
    <div className="animate-fadeIn">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-schibsted font-bold text-white mb-1">Earning Report</h1>
        <p className="text-text-body">Track your income and analyze your financial performance</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <div>
          <h3 className="font-schibsted text-2xl text-white mb-4">Monthly Earnings Trend</h3>
          <EarningsChart />
        </div>
        <TopClients />
      </div>
