...
/**
 * TableActions component for sections management page
  ...
  return (
    <div className="mb-6 flex justify-between items-center">
      <div className="flex items-center gap-4">
        ...
        {selectedCount > 0 && (
          <button
            ...
            className="bg-red-500/20 p-2 rounded-lg hover:bg-red-500/30 transition-all transform hover:scale-105"
            aria-label="Delete selected sections"
            disabled={isProcessing}
          >
            <div className="relative">
              <img src={DeleteIcon} alt="Delete" className="w-5 h-5 text-red-500 filter brightness-150" />
      ...
      <div className="flex items-center gap-4">
        ...
        <Button
          variant="primary"
          className={`px-4 py-2 bg-gradient-to-r from-[#7c11ff] via-white to-[#FF8067] shadow-sm transform hover:scale-105 transition-all ${(isProcessing || isLoading) ? 'opacity-50 cursor-not-allowed' : ''}`}
